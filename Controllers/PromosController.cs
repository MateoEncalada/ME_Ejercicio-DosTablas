...
namespace ME_Ejercicio_DosTablas.Controllers
{
    public class PromosController : Controller
    {
        private readonly ME_DBContext _context;

        public PromosController(ME_DBContext context)
        {
            _context = context;
        }
        ...
        {
            var mE_DBContext = _context.Promo.Include(p => p.Burger);
            return View(await mE_DBContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ME_DBContext.Promo'  is null.");
            }
            var promo = await _context.Promo.FindAsync(id);
            if (promo != null)
            {
